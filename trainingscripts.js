...
function createTiles() {
    ...
    var tileContent = [
      ...
      { title: '1/2 drbl & shoot', icon:'fa-solid fa-futbol', hyperlink: '#', text: 'Players line up on 1/2 way line and dribble with the ball to the box and take a shot. <b>Variants include relay race, 1v1, dribble around cones, with defenders & without. </b>' },
      { title: 'Cone/Pole Drbl', icon:'fa-solid fa-shoe-prints',  hyperlink: '#', text: 'Min 3 cones/poles, players line up to dribble around the cones/poles, with 1 player/coach feeding passes to the players to start dribbling.' },
